...
with open('ex1.txt', 'w', encoding='utf-8') as f:
    ...
    for epoch in range(1, 201):
        ...
        # Save the results of each epoch in ex1.txt file
    ...
    f.write(f'\nFinal Test Accuracy (Best Val Model): {final_test_acc:.4f}\n')

    end_time = time.time()  # End the timer
    execution_time = end_time - start_time  # Calculate execution time

print(f"Results have been saved to 'ex1.txt'. Execution time: {execution_time:.2f} seconds.")
